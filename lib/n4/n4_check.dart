...
import 'package:loto_app/n4/n4_edit.dart';
import 'package:loto_app/n4/n4_enter.dart';
import 'package:sqflite/sqflite.dart';

// Loto6CheckウィジェットのStatefulWidgetクラス
class N4Check extends StatefulWidget {
  final String n4Check;

  const N4Check(this.n4Check, {Key? key}) : super(key: key);

  @override
  _N4Check createState() => _N4Check();
}

// N4CheckウィジェットのStateクラス
class _N4Check extends State<N4Check> {
  // 変数の初期化
                              ...
                              children: [
                                Column(
                                  children: [
                                    ...
                                    i['main1'],i['main2'],i['main3'],i['main4'],i['type'],
                                    _dataListA)),
                              ],
                            ),
                          ],
    ...
    switch (type){
      case 0:
        if(selectedNumber1 == winningNumbers[index]['main1'] && 
            ...
            selectedNumber4==winningNumbers[index]['main4']){
              allcount = 'ストレートあたり';
            }else{
              allcount = 'はずれ';
            }
