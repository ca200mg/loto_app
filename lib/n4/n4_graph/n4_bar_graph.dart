...
class N4BarGraph extends StatelessWidget {
  final List countValue;
  final List countKey;
  const N4BarGraph({super.key, required this.countKey, required this.countValue});

  @override
  Widget build(BuildContext context) {
    // initialize bar data
    N4BarData myN4barData = N4BarData(
      ...
      myN4barData.initializeN4BarData();
      return
    // Transform.rotate(
    ...
    SizedBox(
        ...
        child: BarChart(
          BarChartData(
            ...
            barGroups: myN4barData.n4BarData
            .map(
