...
import 'package:loto_app/n4/n4_graph/n4_bar_graph.dart';
import 'package:sqflite/sqflite.dart';

class N4CountGraph extends StatefulWidget {
  const N4CountGraph({super.key});

  @override
  State<N4CountGraph> createState() => _N4CountGraphState();
}

class _N4CountGraphState extends State<N4CountGraph> {
        ...
        Column(
          children: [
            ...
            SizedBox(
              height: 200,
              width: 400,
              child: N4BarGraph(countKey: countKey, countValue: countValue,)),
            Switch(
              value: sortOrNot,
...
Future<Map<String, int>> countMainNumbers() async {
  ...
  for (int i = 1; i <= 4; i++) {
    ...
    List<Map<String, dynamic>> result = await database.rawQuery(
      'SELECT main$i, COUNT(*) as count FROM n4 GROUP BY main$i',
    );
