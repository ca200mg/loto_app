...
import 'package:loto_app/bingo/bingo_graph/bingo_bar_data.dart';

class BingoBarGraph extends StatelessWidget {
  final List countValue;
  final List countKey;
  const BingoBarGraph({super.key, required this.countKey, required this.countValue});

  @override
  Widget build(BuildContext context) {
    // initialize bar data
    BingoBarData myBingobarData = BingoBarData(
      ...
      myBingobarData.initializeBingoBarData();
      return
    // Transform.rotate(
    ...
    SizedBox(
        ...
        child: BarChart(
          BarChartData(
            ...
            barGroups: myBingobarData.bingoBarData
            .map(
