import 'package:loto_app/n3/n3_graph/n3_individual_bar.dart';
...
class N3BarData {
  ...
  List<N3IndividualBar> n3BarData = [];
  
  void initializeN3BarData() {
    n3BarData = [
      N3IndividualBar(x: key_01, y: value_01),
      N3IndividualBar(x: key_02, y: value_02),
      N3IndividualBar(x: key_03, y: value_03),
      N3IndividualBar(x: key_04, y: value_04),
      N3IndividualBar(x: key_05, y: value_05),
      N3IndividualBar(x: key_06, y: value_06),
      N3IndividualBar(x: key_07, y: value_07),
      N3IndividualBar(x: key_08, y: value_08),
      N3IndividualBar(x: key_09, y: value_09),
      N3IndividualBar(x: key_10, y: value_10),
    ];
  }
}