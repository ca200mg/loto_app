...
class Loto7Enter extends StatefulWidget {
  final int no;
  final String date;
  const Loto7Enter({Key? key, required this.no, required this.date}) : super(key: key);

  @override
  State<Loto7Enter> createState() => _Loto7EnterState();
}

class _Loto7EnterState extends State<Loto7Enter> {
  Set<int> numberSet = {};
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: (numberSet.length == 7) ? () async {
            ...
            await setNewLoto7Nums(widget.no, widget.date, preNumSetList2);
...
Future setNewLoto7Nums(int no, String date, List<String> numSetList)async{
