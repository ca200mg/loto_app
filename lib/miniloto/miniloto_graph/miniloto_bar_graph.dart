...
import 'package:loto_app/miniloto/miniloto_graph/miniloto_bar_data.dart';

class MinilotoBarGraph extends StatelessWidget {
  final List countValue;
  final List countKey;
  const MinilotoBarGraph({super.key, required this.countKey, required this.countValue});

  @override
  Widget build(BuildContext context) {
    // initialize bar data
    MinilotoBarData myMinilotobarData = MinilotoBarData(
      ...
      myMinilotobarData.initializeMinilotoBarData();
      return
    // Transform.rotate(
    ...
    SizedBox(
        ...
        child: BarChart(
          BarChartData(
            ...
            barGroups: myMinilotobarData.minilotoBarData
            .map(
