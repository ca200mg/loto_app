...
class MinilotoDataDisplay extends StatefulWidget {
  final String minilotoDataDisplay;
  const MinilotoDataDisplay(this.minilotoDataDisplay, {Key? key}) : super(key: key);

  @override
  _MinilotoDataDisplay createState() => _MinilotoDataDisplay();
}

class _MinilotoDataDisplay extends State<MinilotoDataDisplay> {
